...
class Game {
  ...
  drawPill(xPos, yPos, orientation, color1 = randomColor(), color2 = randomColor()) {
    if (orientation === 'horizontal1') {
      this.drawBlock(xPos, yPos, color1);
      this.drawBlock(xPos - 1, yPos, color2);
    } else if (orientation === 'vertical1') {
      this.drawBlock(xPos, yPos, color1);
      this.drawBlock(xPos, yPos + 1, color2);
    } else if (orientation === 'horizontal2') {
      this.drawBlock(xPos, yPos, color2);
      this.drawBlock(xPos, yPos + 1, color1);
